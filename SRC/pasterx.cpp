...
CamewaDescwipsion GetViewPoint() {
	char v1; // r8
	CamewaDescwipsion ViewPoint = ReadBizzy<CamewaDescwipsion>(base_address + 0xED57310); // 0xED57310 = EncryptedViewPoint
...
menu_:
	...
	Sleep(2500);
	printf((" \n PasterX Source Updated By Payson Holmes \n"));
	printf((" [1] Load Cheat\n [2] Load Driver\n\n > "));
	std::cin >> choice;
	switch (choice)
	{
	...
	case 2:
		...
		system(E("cls"));
		MessageBoxA(NULL, "Loaded Drivers", "PasterX Updated By Payson", MB_OK);
		goto menu_;
		break;
	}
...

{
	...
	SetConsoleTitleA("PasterX Updated By Payson Holmes");
...
void DrawESP() {
	...
	Uworld = ReadBizzy<DWORD_PTR>(base_address + 0xEE2F8E8);
